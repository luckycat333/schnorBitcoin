...
from generate_p2rt_address import generate_p2tr_address
def create_keypair(n_keys: int):
    ...
    for i in range(0, n_keys):
        ...
        hex_pubkey = bytes_from_point(publickey).hex()

        # Generate p2tr address
        address = generate_p2tr_address(hex_pubkey, network='testnet')
        print("Taproot Address:", address)
